...
# Hard-coded guardrails - these ALWAYS run regardless of AI
...
def validate_sql(sql):
    ...
    # Step 1 - Hard guardrails first (always runs)
    guardrail_check(sql)
...
Nothing else."""
    ...
    try:
        ...
        # If AI fails, guardrails already passed so it's safe to continue
