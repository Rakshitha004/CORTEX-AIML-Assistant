...
import { MessageSquare, Activity, Clock, Database, BarChart2 } from 'lucide-react';
...
export const TeacherDashboard = () => {
  ...
  const userName = localStorage.getItem('cortex_user_name') || 'Teacher';
      ...
      <div className="max-w-7xl mx-auto" data-testid="teacher-dashboard">
        <motion.div variants={container} initial="hidden" animate="show">
          ...
          <motion.div variants={item} className="flex items-center justify-between mb-8">
            <div>
              <p className="text-white/30 text-sm mb-1 tracking-wide">TEACHER OVERVIEW</p>
